...
function getBU(filename){
    return new Promise((function(resolve, reject) {
        ...
        if(dataJson.conteudo.entidadeBoletimUrna.resultadosVotacaoPorEleicao.content.length > 1)
            pointer = dataJson.conteudo.entidadeBoletimUrna.resultadosVotacaoPorEleicao.content[1]?.resultadosVotacao.content[0].totaisVotosCargo.content[0];
        else
            pointer = dataJson.conteudo.entidadeBoletimUrna.resultadosVotacaoPorEleicao.content[0]?.resultadosVotacao.content[0].totaisVotosCargo.content[0];
